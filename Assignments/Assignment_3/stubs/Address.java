...
public class Address {
	...
	public boolean equals( Address address ) {
		//INSERT YOUR CODE HERE...
		return address.getUnit() == this.unit && address.getStreetNumber() == this.streetNumber && address.getStreetName() == this.streetName && address.getPostalCode() == this.postalCode && address.getCity() == this.city && address.getProvince() == this.province && address.getType() == this.getType() && address.getCountry() == this.country;
	}
